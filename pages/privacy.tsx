    ...
    <>
      ...
      <Layout>
        <div className="container prose flex-grow p-1 md:p-6">
          ...
          <p>
            At PistonPost, accessible from https://post.pistonmaster.net, one of
            our main priorities is the privacy of our visitors. This Privacy
            Policy document contains types of information that is collected and
            recorded by PistonPost and how we use it.
          </p>
          ...
          <p>
            PistonPost legal basis for collecting and using the personal
          ...
          <ul>
            <li>PistonPost needs to perform a contract with you</li>
            <li>You have given PistonPost permission to do so</li>
            <li>
              Processing your personal information is in PistonPost legitimate
              interests
            </li>
            <li>PistonPost needs to comply with the law</li>
          </ul>

          <p>
            PistonPost will retain your personal information only for as long as
          ...
          <p>
            PistonPost follows a standard procedure of using log files. These
          ...
          <p>
            Like any other website, PistonPost uses &apos;cookies&apos;. These
          ...
          <p>
            ...
            advertising partners of PistonPost.
          </p>

          <p>
            Third-party ad servers or ad networks uses technologies like
            cookies, JavaScript, or Web Beacons that are used in their
            respective advertisements and links that appear on PistonPost, which
          ...
          <p>
            Note that PistonPost has no access to or control over these cookies
          ...
          <p>
            PistonPost&apos;s Privacy Policy does not apply to other advertisers
          ...
          <p>
            PistonPost does not knowingly collect any Personal Identifiable
          ...
          <p>
            ...
            PistonPost. This policy is not applicable to any information
