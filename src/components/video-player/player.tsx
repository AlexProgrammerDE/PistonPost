    ...
    <MediaProvider debug={debug}>
      ...
      >
        ...
        <Layout.PlayerContainer className="size-full min-h-0">
          ...
          {children}
          <Layout.ControlsOverlayContainer className="bg-linear-[to_top,var(--lp-controls-fade-stops)] bg-size-[100%_80%] bg-top bg-no-repeat transition-opacity duration-300 ease-out group-data-[idle=true]/root:opacity-0 group-data-[status=buffering]/root:opacity-100 group-data-[status=error]/root:opacity-100 group-data-[status=paused]/root:opacity-100" />
          <Layout.ControlsOverlayContainer className="bg-linear-[to_bottom,var(--lp-controls-fade-stops)] bg-size-[100%_45%] bg-bottom bg-no-repeat transition-opacity duration-300 ease-out group-data-[idle=true]/root:opacity-0 group-data-[status=buffering]/root:opacity-100 group-data-[status=error]/root:opacity-100 group-data-[status=paused]/root:opacity-100" />
          <Layout.ControlsContainer
            className={`mx-auto w-full @3xl/root:max-w-6xl @5xl/root:max-w-[1728px]`}
          >
            <TopOverlayContainer className="px-[5%] pt-[clamp(0.75rem,7svh,2.5rem)] transition-all duration-300 ease-[cubic-bezier(0.25,0.46,0.45,0.94)] group-data-[idle=false]/root:translate-y-0 group-data-[idle=false]/root:opacity-100 group-data-[idle=true]/root:-translate-y-4 group-data-[idle=true]/root:opacity-0 group-data-[status=buffering]/root:translate-y-0 group-data-[status=buffering]/root:opacity-100 group-data-[status=error]/root:translate-y-0 group-data-[status=error]/root:opacity-100 group-data-[status=paused]/root:translate-y-0 group-data-[status=paused]/root:opacity-100 @3xl/root:px-[min(80px,10%)]" />
            <CaptionsContainer className="px-[5%] pb-[clamp(0.5rem,4svh,1.5rem)] @3xl/root:px-[min(80px,10%)]" />
            <BottomControls className="px-[5%] pb-[clamp(0.75rem,7svh,2.5rem)] transition-all duration-300 ease-[cubic-bezier(0.25,0.46,0.45,0.94)] group-data-[idle=false]/root:translate-y-0 group-data-[idle=false]/root:opacity-100 group-data-[idle=true]/root:translate-y-4 group-data-[idle=true]/root:opacity-0 group-data-[status=buffering]/root:translate-y-0 group-data-[status=buffering]/root:opacity-100 group-data-[status=error]/root:translate-y-0 group-data-[status=error]/root:opacity-100 group-data-[status=paused]/root:translate-y-0 group-data-[status=paused]/root:opacity-100 @3xl/root:px-[min(80px,10%)]" />
          </Layout.ControlsContainer>
