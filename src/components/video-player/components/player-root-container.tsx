...
export const PlayerRootContainer = React.forwardRef<HTMLDivElement, PlayerRootContainerProps>(
  function PlayerRootContainer(props, ref) {
    ...
    return (
      <RootContainer
        ...
        onBlur={composeEventHandlers(rootProps.onBlur, controlsVisibility.rootProps.onBlur)}
        onFocus={composeEventHandlers(rootProps.onFocus, controlsVisibility.rootProps.onFocus)}
