...
>((props, ref) => {
  ...
  const disabled = props.disabled || readyState < MediaReadyState.HAVE_METADATA || !hasAudio
...
export const Thumb = React.forwardRef<HTMLDivElement, ThumbProps>((props, ref) => {
  ...
  return (
    <SliderPrimitive.Thumb
      ...
      className={cn(
        `block size-2 rounded-full bg-primary focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary/50 has-[input:focus-visible]:outline-2 has-[input:focus-visible]:outline-offset-2 has-[input:focus-visible]:outline-primary/50 data-disabled:bg-primary/85`,
        className,
      )}
      ref={ref}
      {...etc}
