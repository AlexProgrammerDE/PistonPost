...
export const reactionTypeSchema = Schema.Literal("like", "dislike", "heart")
export const themeSchema = Schema.Literal("system", "light", "dark")
...
export type PostVisibility = Schema.Schema.Type<typeof postVisibilitySchema>
export type ReactionType = Schema.Schema.Type<typeof reactionTypeSchema>
