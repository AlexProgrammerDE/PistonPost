import { PostRepository, RepositoryError, type PostRepositoryService } from "@pistonpost/domain"
...
export function postRepositoryLayer(database: Database) {
  return Layer.succeed(PostRepository, createPostRepository(database))
}
