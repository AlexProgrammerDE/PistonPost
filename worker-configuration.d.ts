/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.dev.vars.example` (hash: 58c6afdc0c76f2873e067222957a798d)
// Runtime types generated with workerd@1.20260815.1 2026-07-14 nodejs_compat
interface __BaseEnv_Env {
	...
	IMAGE_UPLOAD_RATE_LIMITER: RateLimit;
	POST_VIEW_RATE_LIMITER: RateLimit;
	IMAGES: ImagesBinding;
	STREAM: StreamBinding;
	ASSETS: Fetcher;
	APP_ENV: "preview" | "production" | "development";
	PUBLIC_APP_URL: "https://staging.post.pistonmaster.net" | "https://post.pistonmaster.net" | "http://localhost:3000";
	TURNSTILE_SITE_KEY: "replace-with-preview-site-key" | "replace-with-production-site-key" | "1x00000000000000000000AA";
	AUTH_EMAIL_FROM: "PistonPost Staging <auth@transactional.pistonmaster.net>" | "PistonPost Auth <auth@transactional.pistonmaster.net>";
	NOTIFICATIONS_EMAIL_FROM: "PistonPost Staging <notifications@transactional.pistonmaster.net>" | "PistonPost <notifications@transactional.pistonmaster.net>";
	MARKETING_EMAIL_FROM: "PistonPost Updates <updates@transactional.pistonmaster.net>";
	SUPPORT_EMAIL: "support@pistonmaster.net";
	VAPID_PUBLIC_KEY: "" | "BKWIQi-fqBMqJPwppNAh1XLTJSGD7tR1S1HzFp5RYBY8NWjOR6eAPKSnSlKQY9z1qBt3SjF_2d-WWUlPb6rTeto";
	...
	ACCOUNT_DELETION: Workflow<Parameters<import("./src/server").AccountDeletionWorkflow['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "PUBLIC_APP_URL" | "TURNSTILE_SITE_KEY" | "AUTH_EMAIL_FROM" | "NOTIFICATIONS_EMAIL_FROM" | "MARKETING_EMAIL_FROM" | "SUPPORT_EMAIL" | "VAPID_PUBLIC_KEY" | "VAPID_SUBJECT" | "BETTER_AUTH_SECRET" | "EMAIL_UNSUBSCRIBE_SECRET" | "BETTER_AUTH_API_KEY" | "TURNSTILE_SECRET" | "STREAM_WEBHOOK_SECRET" | "STREAM_ACCOUNT_ID" | "STREAM_API_TOKEN" | "VAPID_PRIVATE_KEY">> {}
}
