...
non-canonical bytes before writing to R2. A new post can contain 150 images, with a limit of 15 MB
and 80 megapixels per image. Image bytes have a dedicated per-user limit of 180 requests per minute.
