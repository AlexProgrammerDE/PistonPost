...
CI scans the production client build for server-only package markers and local secret values. It
reports bundle sizes for visibility without enforcing a hard size limit.
