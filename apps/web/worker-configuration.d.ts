/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 6b9d5b7f3358772b9be62c837ef78eb2)
...
interface __BaseEnv_Env {
	...
	PUBLIC_APP_URL: "https://staging.example.invalid" | "https://example.invalid" | "http://localhost:3000";
	TURNSTILE_SITE_KEY: "replace-with-preview-site-key" | "replace-with-production-site-key" | "1x00000000000000000000AA";
	AUTH_EMAIL_FROM: "PistonPost Staging <auth@transactional.pistonpost.com>" | "PistonPost Auth <auth@transactional.pistonpost.com>";
	NOTIFICATIONS_EMAIL_FROM: "PistonPost Staging <notifications@transactional.pistonpost.com>" | "PistonPost <notifications@transactional.pistonpost.com>";
	SUPPORT_EMAIL: "support@pistonpost.com";
...
declare namespace Cloudflare {
	...
	interface PreviewEnv {
		...
		AUTH_EMAIL_FROM: "PistonPost Staging <auth@transactional.pistonpost.com>";
		NOTIFICATIONS_EMAIL_FROM: "PistonPost Staging <notifications@transactional.pistonpost.com>";
		SUPPORT_EMAIL: "support@pistonpost.com";
		BETTER_AUTH_SECRET: string;
		TURNSTILE_SECRET: string;
		STREAM_WEBHOOK_SECRET: string;
	...
	interface ProductionEnv {
		...
		AUTH_EMAIL_FROM: "PistonPost Auth <auth@transactional.pistonpost.com>";
		NOTIFICATIONS_EMAIL_FROM: "PistonPost <notifications@transactional.pistonpost.com>";
		SUPPORT_EMAIL: "support@pistonpost.com";
		BETTER_AUTH_SECRET: string;
		TURNSTILE_SECRET: string;
		STREAM_WEBHOOK_SECRET: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "PUBLIC_APP_URL" | "TURNSTILE_SITE_KEY" | "AUTH_EMAIL_FROM" | "NOTIFICATIONS_EMAIL_FROM" | "SUPPORT_EMAIL" | "BETTER_AUTH_SECRET" | "TURNSTILE_SECRET" | "STREAM_WEBHOOK_SECRET">> {}
}
